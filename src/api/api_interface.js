...
export const updateProfile = async (update_user_data) => {
  try {
    const response = await apiService(
      "date-me/user/update-profile",
      "POST",
      update_user_data
    );
    return response;
...
export const getAllUsers = async () => {
  try {
    const response = await apiService("date-me/admin/getUsers", "GET");
    return response;
  } catch (error) {
    throw error;
  }
...
export const getGenders = async () => {
  try {
    const response = await apiService("date-me/admin/getGenders", "GET");
    return response;
  } catch (error) {
    throw error;
  }
...
export const getAllInterests = async () => {
  try {
    const response = await apiService("date-me/user/get-all-interests", "GET");
    return response;
  } catch (error) {
    throw error;
  }
